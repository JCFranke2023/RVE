...
options = {
    ...
    'lanczos':OFF,
    'libs':[],
    'listener_name':'PlasmaPower.win.ikv.rwth-aachen.de',
    'listener_resource':'39548',
    'magnetostatic':OFF,
    'massDiffusion':ON,
    ...
    'mp_head_node':('plasmapower.win.ikv.rwth-aachen.de', 'plasmapower', '134.130.211.42'),
    'mp_host_list':(('plasmapower', 32),),
    'mp_mode':MPI,
    'mp_mode_requested':MPI,
    'mp_mpi_validate':OFF,
    'mp_rsh_command':'dummy %H -l franke -n %C',
    'multiphysics':OFF,
    'noDmpDirect':[],
    'noMultiHost':[],
    'noMultiHostElemLoop':[],
